...
public class CookieUtils {
	...
	public static Cookie getCookie(HttpServletRequest request, String name) {
		...
		if (StringUtils.isEmpty(cookies) && cookies.length < 1) {
			return null;
		}
		Cookie cookie = null;
	 ...
	 * @return
	 */
	public static boolean removeCookies(HttpServletRequest request, HttpServletResponse response, String name) {
